...
@[code](./res/native-code/arrayOf.ts)
@[code](./res/native-code/callFunc.ts)
@[code](./res/native-code/checkThis.ts)
@[code](./res/native-code/curry.ts)
@[code](./res/native-code/isType.ts)
@[code](./res/native-code/mapFunc.ts)
@[code](./res/native-code/memorise.ts)
@[code](./res/native-code/thisFunc.ts)
